...
class OrderProcessorTest {
    ...
    @Test
    void processExecutionBuy() {
        OrderProcessor orderProcessor = new OrderProcessor();
        // 2 orders, different price, execution will match the second and partially fill it
        OrderEntry orderEntry1 = new OrderEntry(1L , ISIN_1, BigDecimal.valueOf(100), BigDecimal.valueOf(100), TIME_0, OrderType.BUY, BigDecimal.valueOf(5), OrderEntryStatus.OPEN);
        OrderEntry orderEntry2 = new OrderEntry(2L , ISIN_1, BigDecimal.valueOf(100), BigDecimal.valueOf(100), TIME_1, OrderType.BUY, BigDecimal.valueOf(6), OrderEntryStatus.OPEN);
        OrderEntry orderEntry3 = new OrderEntry(3L , ISIN_2, BigDecimal.valueOf(100), BigDecimal.valueOf(100), TIME_1, OrderType.BUY, BigDecimal.valueOf(6), OrderEntryStatus.OPEN);
        List<OrderEntry> orders = Arrays.asList(orderEntry1, orderEntry2,orderEntry3);
        Execution execution1 =  new Execution(1L, ISIN_1, BigDecimal.valueOf(60), BigDecimal.valueOf(5.5), ExecutionType.OFFER);
        ...
        // a second execution will fill both orders
        Execution execution2 =  new Execution(2L, ISIN_1, BigDecimal.valueOf(200), BigDecimal.valueOf(5), ExecutionType.OFFER);
